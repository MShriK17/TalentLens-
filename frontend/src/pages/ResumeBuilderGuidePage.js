...
const HOW_IT_WORKS_ADVANCED = [
  ...
  },
  {
    ...
    desc: "From the AI Dashboard, select shortlisted candidates and send personalised shortlist, interview invite, or next-round emails — with the AI analysis PDF attached automatically.",
    color: "#7C3AED", bg: "#F5F3FF",
  },
  {
    step: "08",
...
const PLATFORM_FEATURES = [
  ...
  },
  {
    ...
    title: "Email Shortlisted Candidates",
    desc: "Send shortlist, interview invite, or rejection emails to candidates directly from the AI Dashboard. AI PDF report attached automatically.",
